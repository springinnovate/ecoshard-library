...
class QueryPropAnyOf(Model):
    ...
    def __init__(self, eq=None, neq=None, gt=None, lt=None, gte=None, lte=None, starts_with=None, ends_with=None, contains=None, _in=None):  # noqa: E501
        """QueryPropAnyOf - a model defined in OpenAPI

        :param eq: The eq of this QueryPropAnyOf.  # noqa: E501
        :type eq: OneOfstringnumberboolean
        :param neq: The neq of this QueryPropAnyOf.  # noqa: E501
        :type neq: OneOfstringnumberboolean
        :param gt: The gt of this QueryPropAnyOf.  # noqa: E501
        :type gt: OneOfDateTimenumber
        :param lt: The lt of this QueryPropAnyOf.  # noqa: E501
        :type lt: OneOfDateTimenumber
        :param gte: The gte of this QueryPropAnyOf.  # noqa: E501
        :type gte: OneOfDateTimenumber
        :param lte: The lte of this QueryPropAnyOf.  # noqa: E501
        :type lte: OneOfDateTimenumber
        :param starts_with: The starts_with of this QueryPropAnyOf.  # noqa: E501
        :type starts_with: str
        :param ends_with: The ends_with of this QueryPropAnyOf.  # noqa: E501
        :type ends_with: str
        :param contains: The contains of this QueryPropAnyOf.  # noqa: E501
        :type contains: str
        :param _in: The _in of this QueryPropAnyOf.  # noqa: E501
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'QueryPropAnyOf':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The queryProp_anyOf of this QueryPropAnyOf.  # noqa: E501
        :rtype: QueryPropAnyOf
        """
        return util.deserialize_model(dikt, cls)

    @property
    def eq(self):
        """Gets the eq of this QueryPropAnyOf.
        ...
        :return: The eq of this QueryPropAnyOf.
    ...
    @eq.setter
    def eq(self, eq):
        """Sets the eq of this QueryPropAnyOf.

        Find items with a property that is equal to the specified value. For strings, a case-insensitive comparison must be performed.  # noqa: E501

        :param eq: The eq of this QueryPropAnyOf.
        :type eq: OneOfstringnumberboolean
        """
    ...
    @neq.setter
    def neq(self, neq):
        """Sets the neq of this QueryPropAnyOf.

        Find items that *don't* contain the specified value. For strings, a case-insensitive comparison must be performed.  # noqa: E501

        :param neq: The neq of this QueryPropAnyOf.
        :type neq: OneOfstringnumberboolean
        """
    ...
    @gt.setter
    def gt(self, gt):
        """Sets the gt of this QueryPropAnyOf.

        Find items with a property value greater than the specified value.  # noqa: E501

        :param gt: The gt of this QueryPropAnyOf.
        :type gt: OneOfDateTimenumber
        """
    ...
    @lt.setter
    def lt(self, lt):
        """Sets the lt of this QueryPropAnyOf.

        Find items with a property value less than the specified value.  # noqa: E501

        :param lt: The lt of this QueryPropAnyOf.
        :type lt: OneOfDateTimenumber
        """
    ...
    @gte.setter
    def gte(self, gte):
        """Sets the gte of this QueryPropAnyOf.

        Find items with a property value greater than or equal the specified value.  # noqa: E501

        :param gte: The gte of this QueryPropAnyOf.
        :type gte: OneOfDateTimenumber
        """
    ...
    @lte.setter
    def lte(self, lte):
        """Sets the lte of this QueryPropAnyOf.

        Find items with a property value less than or equal the specified value.  # noqa: E501

        :param lte: The lte of this QueryPropAnyOf.
        :type lte: OneOfDateTimenumber
        """
    ...
    def starts_with(self):
        """Gets the starts_with of this QueryPropAnyOf.
        ...
        :return: The starts_with of this QueryPropAnyOf.
        :rtype: str
        """
    ...
    def starts_with(self, starts_with):
        """Sets the starts_with of this QueryPropAnyOf.

        Find items with a property that begins with the specified string. A case-insensitive comparison must be performed.  # noqa: E501

        :param starts_with: The starts_with of this QueryPropAnyOf.
        :type starts_with: str
        """
    ...
    def ends_with(self, ends_with):
        """Sets the ends_with of this QueryPropAnyOf.

        Find items with a property that ends with the specified string. A case-insensitive comparison must be performed.  # noqa: E501

        :param ends_with: The ends_with of this QueryPropAnyOf.
        :type ends_with: str
        """
    ...
    @property
    def contains(self):
        """Gets the contains of this QueryPropAnyOf.
        ...
        :return: The contains of this QueryPropAnyOf.
        :rtype: str
        """
    ...
    def contains(self, contains):
        """Sets the contains of this QueryPropAnyOf.

        Find items with a property that contains the specified literal string, e.g., matches \".*<STRING>.*\". A case-insensitive comparison must be performed.  # noqa: E501

        :param contains: The contains of this QueryPropAnyOf.
        :type contains: str
        """
    ...
    @property
    def _in(self):
        """Gets the _in of this QueryPropAnyOf.
        ...
        :return: The _in of this QueryPropAnyOf.
    ...
    @_in.setter
    def _in(self, _in):
        """Sets the _in of this QueryPropAnyOf.

        Find items with a property that equals at least one entry in the specified array. A case-insensitive comparison must be performed.  # noqa: E501

        :param _in: The _in of this QueryPropAnyOf.
        :type _in: List[OneOfstringnumber]
        """
