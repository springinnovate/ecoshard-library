...
nohup python3 resize_and_flush_service.py --app_port 8081 --disk_pattern geoserver-data-disk* --mount_point /mnt/geoserver_data > resize_and_flush_service_log.txt &
popd
