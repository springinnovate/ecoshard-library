...
if __name__ == '__main__':
    ...
    class CatalogEntry(db.Model):
        ...
        xmin = db.Column(db.Float, nullable=False, index=True)
        xmax = db.Column(db.Float, nullable=False, index=True)
        ymin = db.Column(db.Float, nullable=False, index=True)
        ymax = db.Column(db.Float, nullable=False, index=True)
